...
const App: React.FC = () => {
  ...
  const primaryBtnClass = "w-12 h-12 rounded-[1.2rem] bg-white border border-white flex items-center justify-center active:scale-90 transition-all shrink-0 disabled:opacity-20";
            ...
            <>
              ...
              <button onClick={runAI} disabled={!capturedImage || isGenerating} className={primaryBtnClass} title="Generate">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6 text-black">
                  <path d="M14.633 7.189l2.547-2.547a.75.75 0 111.06 1.06l-2.546 2.548a.75.75 0 11-1.061-1.06zm-9.207 9.208a.75.75 0 010 1.06l-2.547 2.547a.75.75 0 01-1.06-1.06l2.546-2.547a.75.75 0 011.061 0zM7.19 14.633a.75.75 0 011.06 0l2.547 2.547a.75.75 0 11-1.06 1.06L7.19 15.694a.75.75 0 010-1.061zm9.208-9.207a.75.75 0 011.061 0l2.547 2.546a.75.75 0 11-1.06 1.06l-2.547-2.546a.75.75 0 010-1.06zM12 7.5a4.5 4.5 0 110 9 4.5 4.5 0 010-9zm0 1.5a3 3 0 100 6 3 3 0 000-6z" />
                  <path fillRule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.36-4.14a.75.75 0 10-1.06-1.06l-6.5 6.5a.75.75 0 101.06 1.06l6.5-6.5z" clipRule="evenodd" />
                </svg>
              </button>
            </>
          ) : (
            ...
            <>
              ...
              <button onClick={runAI} disabled={isGenerating} className={commonBtnClass} title="Regenerate">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5 text-white/50">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12c0-1.232-.37-2.377-1-3.33M4.5 12c0 1.232.37 2.377 1 3.33m13.5-3.33a7.5 7.5 0 11-13.5 0m13.5 0H21m-16.5 0H3" />
                </svg>
              </button>
            </>
          )}
